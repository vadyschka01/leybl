...
static void ds_packet(unsigned short throttle, bool tele, unsigned short* buff, unsigned long shift)
{
...
void DSHOT_SetCommand(unsigned short Command[4])
{
  if(!Command) return;
  ...
  if(DSHOT_Comm[DSHOT_TIM2][DSHOT_CCR1]!=Command[0] || DSHOT_Comm[DSHOT_TIM2][DSHOT_CCR2]!=Command[1])
  {
    ...
    ds_packet(c1 & 0x0FFF, c1 >> 15, buf, DSHOT_CCR1);
    ds_packet(c2 & 0x0FFF, c2 >> 15, buf, DSHOT_CCR2);
  ...
  if(DSHOT_Comm[DSHOT_TIM1][DSHOT_CCR3]!=Command[2] || DSHOT_Comm[DSHOT_TIM1][DSHOT_CCR4]!=Command[3])
  {
    ...
    ds_packet(c3 & 0x0FFF, c3 >> 15, buf, DSHOT_CCR3);
    ds_packet(c4 & 0x0FFF, c4 >> 15, buf, DSHOT_CCR4);
