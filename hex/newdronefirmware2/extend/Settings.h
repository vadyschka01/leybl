...
public:
  ...
  static constexpr const ParameterData MenuEngineParameters[] = { 
    ...
    {"Motor_UL", &MainEng.HexScheme[0], DATA_TYPES::dt_unsigned_char},
    {"Motor_UU", &MainEng.HexScheme[1], DATA_TYPES::dt_unsigned_char},
    {"Motor_UR", &MainEng.HexScheme[2], DATA_TYPES::dt_unsigned_char},
    {"Motor_DL", &MainEng.HexScheme[3], DATA_TYPES::dt_unsigned_char},
    {"Motor_DD", &MainEng.HexScheme[4], DATA_TYPES::dt_unsigned_char},
    {"Motor_DR", &MainEng.HexScheme[5], DATA_TYPES::dt_unsigned_char}
  };
  ...
  static constexpr const ParameterData MenuSensorsParameters[] = { 
    ...
    {"CamFlow_LensX", &MainCam.Lens.X, DATA_TYPES::dt_float_32},
    {"CamFlow_LensY", &MainCam.Lens.Y, DATA_TYPES::dt_float_32}
  };
