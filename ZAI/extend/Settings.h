...
{
public:
  static constexpr const char* MainMenuNames[] = { "PID", "Engine", "Sensors", "AutoPilot" };
public:
  static constexpr const ParameterData MenuPIDParameters[] = {
    ...
    {"AngleP_IP", &MainAtt.RegAngleP.Int.Pro, DATA_TYPES::dt_float_32}, {"AngleP_ID", &MainAtt.RegAngleP.Int.Der, DATA_TYPES::dt_float_32},
    {"AngleP_ILock", &MainAtt.RegAngleP.LockI, DATA_TYPES::dt_bool},
    ...
    {"AngleR_IP", &MainAtt.RegAngleR.Int.Pro, DATA_TYPES::dt_float_32}, {"AngleR_ID", &MainAtt.RegAngleR.Int.Der, DATA_TYPES::dt_float_32},
    {"AngleR_ILock", &MainAtt.RegAngleR.LockI, DATA_TYPES::dt_bool},
    ...
    {"AngleY_IP", &MainAtt.RegAngleY.Int.Pro, DATA_TYPES::dt_float_32}, {"AngleY_ID", &MainAtt.RegAngleY.Int.Der, DATA_TYPES::dt_float_32},
    {"AngleY_ILock", &MainAtt.RegAngleY.LockI, DATA_TYPES::dt_bool},
    ...
    {"Att_SpeedP_IP", &MainAtt.RegSpeedP.Int.Pro, DATA_TYPES::dt_float_32}, {"Att_SpeedP_ID", &MainAtt.RegSpeedP.Int.Der, DATA_TYPES::dt_float_32},
    {"Att_SpeedP_ILock", &MainAtt.RegSpeedP.LockI, DATA_TYPES::dt_bool},
    ...
    {"Att_SpeedR_IP", &MainAtt.RegSpeedR.Int.Pro, DATA_TYPES::dt_float_32}, {"Att_SpeedR_ID", &MainAtt.RegSpeedR.Int.Der, DATA_TYPES::dt_float_32},
    {"Att_SpeedR_ILock", &MainAtt.RegSpeedR.LockI, DATA_TYPES::dt_bool},
    ...
    {"Att_SpeedY_IP", &MainAtt.RegSpeedY.Int.Pro, DATA_TYPES::dt_float_32}, {"Att_SpeedY_ID", &MainAtt.RegSpeedY.Int.Der, DATA_TYPES::dt_float_32},
    {"Att_SpeedY_ILock", &MainAtt.RegSpeedY.LockI, DATA_TYPES::dt_bool},
    ...
    {"Vel_SpeedX_IP", &MainVel.RegSpeedX.Int.Pro, DATA_TYPES::dt_float_32}, {"Vel_SpeedX_ID", &MainVel.RegSpeedX.Int.Der, DATA_TYPES::dt_float_32},
    {"Vel_SpeedX_ILock", &MainVel.RegSpeedX.LockI, DATA_TYPES::dt_bool},
    ...
    {"Vel_SpeedY_IP", &MainVel.RegSpeedY.Int.Pro, DATA_TYPES::dt_float_32}, {"Vel_SpeedY_ID", &MainVel.RegSpeedY.Int.Der, DATA_TYPES::dt_float_32},
    {"Vel_SpeedY_ILock", &MainVel.RegSpeedY.LockI, DATA_TYPES::dt_bool},
    ...
    {"Vel_SpeedT_IP", &MainVel.RegSpeedT.Int.Pro, DATA_TYPES::dt_float_32}, {"Vel_SpeedT_ID", &MainVel.RegSpeedT.Int.Der, DATA_TYPES::dt_float_32},
    {"Vel_SpeedT_ILock", &MainVel.RegSpeedT.LockI, DATA_TYPES::dt_bool}
  };
  ...
  static constexpr const ParameterData MenuSensorsParameters[] = { 
    ...
    //{"Comp_CourseSpeed", &MainCompas.CourseSpeed, DATA_TYPES::dt_float_32},
    //{"Comp_MaxTimerGPS", &MainCompas.MaxTimerGPS, DATA_TYPES::dt_float_32},
  ...
  static constexpr const ParameterData* MenuParameters[] = {
    MenuPIDParameters, MenuEngineParameters, MenuSensorsParameters, MenuAutoPilotParameters
  };
public:
