...
static float pid_yaw_kp = 0.04f;   // 0.04 
static float pid_yaw_ki = 0.0f;
static float pid_yaw_kd = 0.0450f;  //0.045

// Коэффициенты только для roll (ось X)
static float pid_roll_kp = 0.03f;   //0.03
static float pid_roll_ki = 0.0f;
static float pid_roll_kd = 0.02f;   //0.02

// Коэффициенты только для pitch (ось Y)
static float pid_pitch_kp = 0.0f;   //   0.015
static float pid_pitch_ki = 0.0f;
static float pid_pitch_kd = 0.00900f;   // 0.01150
